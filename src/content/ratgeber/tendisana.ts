...
export const tendisana: Article = {
  slug: "sehnen-baender-gesund-halten",
  productSlug: "tendisana",
  eyebrow: "Sehnen & Bänder",
  title: "Sehnen und Bänder gesund halten: Worauf es im Alter ankommt",
  metaDescription:
  ...
  sections: [
    {
      heading: "Was sich mit den Jahren im Bindegewebe verändert",
      paragraphs: [
    ...
    {
      heading: "Welche Mikronährstoffe Bindegewebe, Knorpel und Knochen tragen",
      paragraphs: [
  ...
  faq: [
    {
      q: "Ist Bewegung bei empfindlichen Sehnen und Bändern nicht riskant?",
      a: "Maßvolle, regelmäßige Bewegung gehört zu den wichtigsten Stützen des Bindegewebes, weil Sehnen und Bänder sich an Belastung anpassen. Entscheidend sind ein langsamer Aufbau, gutes Aufwärmen und Erholungspausen, nicht der Verzicht auf Bewegung.",
    },
    {
      q: "Welche Nährstoffe sind für Sehnen, Bänder und Knochen besonders relevant?",
      a: "Vitamin C trägt zur normalen Kollagenbildung für Knorpel und Knochen bei, Mangan zu einer normalen Bindegewebsbildung. Vitamin D und Zink tragen zur Erhaltung normaler Knochen bei.",
    },
    {
