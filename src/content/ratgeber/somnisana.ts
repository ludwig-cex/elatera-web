...
export const somnisana: Article = {
  slug: "besser-schlafen-im-alter",
  productSlug: "somnisana",
  eyebrow: "Schlaf & Erholung",
  title: "Besser schlafen im Alter: Was abends wirklich zur Ruhe verhilft",
  metaDescription:
  ...
  sections: [
    {
      heading: "Was sich mit den Jahren im Schlaf verändert",
      paragraphs: [
    ...
    {
      heading: "Welche Mikronährstoffe und Melatonin den Abend begleiten",
      paragraphs: [
  ...
  faq: [
    {
      q: "Warum schlafe ich im Alter schlechter als früher?",
      a: "Mit den Jahren verschiebt sich der innere Rhythmus oft nach vorne, der tiefe Schlafanteil nimmt ab und die körpereigene Melatoninbildung lässt nach. Ein regelmäßiger Tagesablauf, Tageslicht am Morgen und eine ruhige Abendroutine können viel ausgleichen.",
    },
    {
      q: "Wie und wann wird Melatonin eingenommen?",
      a: "Melatonin trägt zur Verkürzung der Einschlafzeit bei. Die positive Wirkung stellt sich ein, wenn 1 mg kurz vor dem Schlafengehen eingenommen wird. Auf diese Menge und diesen Zeitpunkt kommt es an.",
    },
    {
      q: "Können Nahrungsergänzungsmittel eine ärztliche Behandlung ersetzen?",
      a: "Nein. Sie sind kein Arzneimittel und ersetzen weder die ärztliche Abklärung noch eine Therapie. Sie können eine ausgewogene Ernährung und einen geregelten Tagesrhythmus begleiten.",
    },
  ],
};
