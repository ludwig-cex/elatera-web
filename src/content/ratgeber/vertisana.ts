...
export const vertisana: Article = {
  slug: "schwindel-gleichgewicht-im-alter",
  productSlug: "vertisana",
  eyebrow: "Gleichgewicht & Balance",
  title: "Gleichgewicht und Schwindel im Alter: Was wirklich hilft",
  metaDescription:
  ...
  sections: [
    {
      heading: "Was sich mit den Jahren im Gleichgewichtssinn verändert",
      paragraphs: [
    ...
    {
      heading: "Welche Mikronährstoffe das Nervensystem unterstützen",
      paragraphs: [
  ...
  faq: [
    {
      q: "Ist Schwindel im Alter immer ein Grund zur Sorge?",
      a: "Gelegentliche Unsicherheit beim schnellen Aufstehen ist verbreitet und meist harmlos. Tritt Schwindel jedoch plötzlich, heftig oder zusammen mit Seh-, Sprach- oder Gefühlsstörungen auf, gehört er ärztlich abgeklärt.",
    },
    {
      q: "Welche Nährstoffe sind für das Nervensystem besonders relevant?",
      a: "Magnesium trägt zur normalen Funktion des Nervensystems bei, ebenso Vitamin B6 und Vitamin B12. Magnesium unterstützt zudem einen normalen Energiestoffwechsel und die Verringerung von Müdigkeit.",
    },
    {
