...
export const gastrosana: Article = {
  slug: "verdauung-magen-unterstuetzen",
  productSlug: "gastrosana",
  eyebrow: "Magen & Verdauung",
  title: "Verdauung und Magen im Alter: Was dem Bauch guttut",
  metaDescription:
  ...
  sections: [
    {
      heading: "Was sich mit den Jahren an Magen und Verdauung verändert",
      paragraphs: [
    ...
    {
      heading: "Welche Mikronährstoffe Schleimhäute und Stoffwechsel tragen",
      paragraphs: [
  ...
  faq: [
    {
      q: "Warum wird die Verdauung mit den Jahren oft langsamer?",
      a: "Mit dem Alter bildet der Körper häufig weniger Magensäure und Verdauungssäfte, die Schleimhäute erneuern sich langsamer und der Darm arbeitet gemächlicher. Ballaststoffe, ausreichend Trinken und Bewegung sind deshalb wichtige Stützen.",
    },
    {
      q: "Welche Nährstoffe sind für Schleimhäute und Verdauung besonders relevant?",
      a: "Vitamin A trägt zur Erhaltung normaler Schleimhäute bei, Zink zu einem normalen Säure-Basen-Stoffwechsel. Vitamin C und Zink tragen zudem dazu bei, die Zellen vor oxidativem Stress zu schützen.",
    },
    {
