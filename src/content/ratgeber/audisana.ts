...
export const audisana: Article = {
  slug: "hoeren-ohren-im-alter",
  productSlug: "audisana",
  eyebrow: "Ohren & Hörfunktion",
  title: "Hören und Ohren im Alter: Was dem Gehör guttut",
  metaDescription:
  ...
  sections: [
    {
      heading: "Was sich mit den Jahren am Gehör verändert",
      paragraphs: [
    ...
    {
      heading: "Welche Mikronährstoffe Nervenfunktion und Zellschutz tragen",
      paragraphs: [
  ...
  faq: [
    {
      q: "Ist es normal, dass das Hören mit dem Alter nachlässt?",
      a: "Eine allmähliche Veränderung des Hörvermögens gehört für viele Menschen zum natürlichen Älterwerden, weil die feinen Haarsinneszellen im Innenohr sich nicht neu bilden. Lärmschutz, eine gute Durchblutung und regelmäßige Hörtests helfen, das Gehör im Alltag aufmerksam zu begleiten.",
    },
    {
      q: "Welche Nährstoffe sind für Nervenfunktion und Zellschutz relevant?",
      a: "Magnesium sowie die Vitamine B1, B6, B12 und C tragen zu einer normalen Funktion des Nervensystems bei. Vitamin C und Zink tragen dazu bei, die Zellen vor oxidativem Stress zu schützen, und Zink unterstützt zusätzlich eine normale kognitive Funktion.",
    },
    {
      q: "Können Nahrungsergänzungsmittel eine ärztliche Behandlung ersetzen?",
      a: "Nein. Sie sind kein Arzneimittel und ersetzen weder die ärztliche Abklärung noch eine Therapie. Bei plötzlichem Hörverlust, anhaltenden Ohrgeräuschen oder Ohrenschmerzen gehört die Ursache ärztlich abgeklärt.",
    },
  ],
};
