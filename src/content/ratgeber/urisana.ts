...
export const urisana: Article = {
  slug: "blase-harnwege-staerken",
  productSlug: "urisana",
  eyebrow: "Blase & Harnwege",
  title: "Blase und Harnwege im Alter: Was Sie selbst tun können",
  metaDescription:
  ...
  sections: [
    {
      heading: "Was sich mit den Jahren an Blase und Harnwegen verändert",
      paragraphs: [
    ...
    {
      heading: "Welche Mikronährstoffe die Schleimhäute tragen",
      paragraphs: [
  ...
  faq: [
    {
      q: "Sollte ich bei häufigem Harndrang weniger trinken?",
      a: "Nein. Zu wenig Flüssigkeit führt zu konzentriertem Urin, der die Blase eher reizt. Sinnvoll ist eine über den Tag verteilte, ausreichende Trinkmenge, abends etwas zurückhaltender für eine ruhigere Nacht.",
    },
    {
      q: "Welche Nährstoffe sind für die Schleimhäute der Harnwege relevant?",
      a: "Vitamin A trägt zur Erhaltung normaler Schleimhäute bei. Zink und Selen tragen dazu bei, die Zellen vor oxidativem Stress zu schützen, und unterstützen gemeinsam mit Vitamin A eine normale Immunfunktion.",
    },
    {
      q: "Können Nahrungsergänzungsmittel eine ärztliche Behandlung ersetzen?",
      a: "Nein. Sie sind kein Arzneimittel und ersetzen weder die ärztliche Abklärung noch eine Therapie. Sie können eine ausgewogene Ernährung und einen aufmerksamen Alltag begleiten.",
    },
  ],
};
