...
export const richtigTrinkenBlase: Article = {
  slug: "richtig-trinken-blase",
  productSlug: "urisana",
  pillarSlug: "blase-harnwege-staerken",
  eyebrow: "Blase & Harnwege",
  title: "Richtig trinken bei empfindlicher Blase im Alter",
  metaDescription:
  ...
  updated: "2026-06-15",
  heroImage: "/ratgeber-img/richtig-trinken-blase.png",
  keyFacts: [
  ...
  sections: [
    {
      heading: "Warum genug trinken auch bei Blasenthemen wichtig bleibt",
      paragraphs: [
    ...
    {
      heading: "Was und wann Sie trinken sollten",
      paragraphs: [
    ...
    {
      heading: "Reizende Getränke im Blick behalten",
      paragraphs: [
  ...
  faq: [
    {
      q: "Sollte ich bei empfindlicher Blase lieber weniger trinken?",
      a: "In der Regel nicht. Zu wenig Flüssigkeit lässt den Urin stärker konzentrieren, was die Blasenschleimhaut eher reizt. Sinnvoller ist es, die Trinkmenge gleichmäßig über den Tag zu verteilen. Bei Herz- oder Nierenerkrankungen oder entwässernden Medikamenten stimmen Sie die passende Menge bitte mit Ihrem Arzt ab.",
    },
    {
      q: "Welche Getränke werden von einer empfindlichen Blase oft weniger gut vertragen?",
      a: "Häufig sind das koffeinhaltige Getränke wie Kaffee und schwarzer Tee, Alkohol sowie stark kohlensäurehaltige und sehr zuckerreiche Limonaden. Ein vollständiger Verzicht ist meist nicht nötig. Achten Sie in Maßen auf Ihr eigenes Empfinden, denn die Verträglichkeit ist individuell verschieden.",
    },
    {
      q: "Wann sollte ich mit Blasenbeschwerden zum Arzt gehen?",
      a: "Lassen Sie Brennen beim Wasserlassen, Blut im Urin, Fieber oder anhaltende Beschwerden ärztlich abklären. Ein Nahrungsergänzungsmittel ist kein Arzneimittel und ersetzt weder eine ausgewogene Ernährung noch eine ärztliche Behandlung.",
    },
  ],
};
