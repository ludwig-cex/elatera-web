...
export const gehirnjoggingAufgaben: Article = {
  slug: "gehirnjogging-aufgaben",
  productSlug: "mentisana",
  pillarSlug: "gedaechtnis-staerken-im-alter",
  eyebrow: "Gedächtnis & Klarheit",
  title: "Gehirnjogging-Aufgaben: 12 Aufgaben mit Lösungen zum sofort Mitmachen",
  metaDescription:
  ...
  relatedSlugs: ["gedaechtnis-guide", "gehirnjogging-ab-60", "gedaechtnistraining-senioren", "gehirnjogging-uebungen", "zink-kognitive-funktion"],
  intro: [
  ...
  sections: [
    {
      heading: "Wortaufgaben: Sprache in Bewegung bringen",
      paragraphs: [
    ...
    {
      heading: "Zahlenaufgaben: Kopfrechnen ohne Taschenrechner",
      paragraphs: [
    ...
    {
      heading: "Merkaufgaben: das Kurzzeitgedächtnis fordern",
      paragraphs: [
    ...
    {
      heading: "Logikaufgaben: um die Ecke denken",
      paragraphs: [
    ...
    {
      heading: "So holen Sie mehr aus den Aufgaben heraus",
      paragraphs: [
  ...
  faq: [
    {
      ...
      a: "Zwei bis drei Aufgaben täglich, gern über den Tag verteilt, sind wirksamer als eine lange Sitzung pro Woche. Entscheidend ist die Regelmäßigkeit und dass die Aufgaben leicht anstrengend bleiben.",
    },
    {
      q: "Sind die Aufgaben auch für Menschen über 70 oder 80 geeignet?",
      a: "Ja. Alle zwölf Aufgaben lassen sich in jedem Alter lösen und über den Schwierigkeitsgrad anpassen: kürzere Merklisten und kleinere Zahlenschritte zum Einstieg, längere Listen und centgenaues Rechnen als Steigerung.",
    },
    {
      q: "Was tun, wenn eine Aufgabe gar nicht gelingt?",
      a: "Nichts erzwingen. Legen Sie die Aufgabe beiseite und versuchen Sie sie am nächsten Tag erneut, gern in einer leichteren Variante. Der Trainingsreiz entsteht beim Überlegen, nicht beim fehlerfreien Lösen. Bei anhaltenden, beunruhigenden Gedächtnisproblemen ist das ärztliche Gespräch der richtige Weg.",
    },
  ],
};
