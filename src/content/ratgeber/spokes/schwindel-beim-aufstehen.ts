...
export const schwindelBeimAufstehen: Article = {
  ...
  title: "Schwindel beim Aufstehen: Was im Körper dahintersteckt",
  metaDescription:
  ...
  sections: [
    {
      heading: "Was beim Aufstehen im Kreislauf passiert",
      paragraphs: [
    ...
    {
      heading: "So gestalten Sie das Aufstehen und Trinken im Alltag",
      paragraphs: [
  ...
  faq: [
    {
      q: "Warum wird mir beim Aufstehen kurz schwindelig?",
      a: "Beim Aufstehen folgt ein Teil des Blutes der Schwerkraft in die Beine, sodass dem Kopf für einen Moment etwas weniger zur Verfügung steht. Normalerweise gleicht der Körper das in Sekunden aus. Mit den Jahren läuft dieser Ausgleich oft langsamer ab. Lassen Sie wiederkehrenden Schwindel bitte ärztlich abklären.",
    },
    {
      q: "Welche Nährstoffe spielen für das Nervensystem eine Rolle?",
      a: "Magnesium sowie die Vitamine B6 und B12 tragen zu einer normalen Funktion des Nervensystems bei. Magnesium trägt zudem zu einer normalen psychischen Funktion und zum normalen Energiestoffwechsel bei. Diese Aussagen gelten für die Nährstoffe selbst, nicht für ein bestimmtes Produkt.",
    },
    {
      q: "Kann ein Nahrungsergänzungsmittel den Schwindel beim Aufstehen beseitigen?",
      a: "Nein. Ein Nahrungsergänzungsmittel ist kein Arzneimittel und ersetzt weder eine ausgewogene Ernährung noch eine ärztliche Behandlung. Es kann einen aktiven, ausgewogenen Alltag begleiten. Bei wiederkehrendem Schwindel sprechen Sie bitte mit Arzt oder Apotheker.",
    },
  ],
};
