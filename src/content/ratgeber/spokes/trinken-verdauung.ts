...
export const trinkenVerdauung: Article = {
  slug: "trinken-verdauung",
  productSlug: "gastrosana",
  pillarSlug: "verdauung-magen-unterstuetzen",
  eyebrow: "Magen & Verdauung",
  title: "Richtig trinken für eine gute Verdauung im Alter",
  metaDescription:
  ...
  updated: "2026-06-15",
  heroImage: "/ratgeber-img/trinken-verdauung.png",
  keyFacts: [
  ...
  sections: [
    {
      heading: "Warum ausreichend Trinken im Alter wichtig ist und oft schwerfällt",
      paragraphs: [
    ...
    {
      heading: "Wie viel und was sinnvoll ist",
      paragraphs: [
    ...
    {
      heading: "Praktische Trink-Tipps für den Alltag",
      paragraphs: [
  ...
  faq: [
    {
      q: "Wie viel sollte ich am Tag trinken?",
      a: "Als Orientierung gelten für gesunde Erwachsene rund 1,5 Liter aus Getränken täglich, bei Hitze oder Aktivität mehr. Verteilen Sie die Menge gleichmäßig über den Tag. Wenn Ihnen ärztlich eine begrenzte Trinkmenge empfohlen wurde, etwa bei Herz- oder Nierenerkrankungen, halten Sie sich bitte an diese Vorgabe.",
    },
    {
      q: "Welche Getränke eignen sich am besten?",
      a: "Wasser sowie ungesüßte Kräuter- und Früchtetees sind die erste Wahl. Stark gezuckerte Getränke und Alkohol sind weniger geeignet, Kaffee und Tee dürfen in üblichen Mengen mit in die Tagesbilanz zählen.",
    },
    {
      q: "Kann ein Nahrungsergänzungsmittel ausreichendes Trinken ersetzen?",
      a: "Nein. Ein Nahrungsergänzungsmittel ist kein Arzneimittel und ersetzt weder ausreichendes Trinken noch eine ausgewogene Ernährung oder eine ärztliche Behandlung. Vitamin A trägt zur Erhaltung normaler Schleimhäute bei, Zink zu einem normalen Säure-Basen-Stoffwechsel. Bei anhaltenden Beschwerden sprechen Sie bitte mit Arzt oder Apotheker.",
    },
  ],
};
