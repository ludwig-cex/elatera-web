...
export const herzgesundeErnaehrung: Article = {
  slug: "herzgesunde-ernaehrung",
  productSlug: "cordisana",
  pillarSlug: "herz-gefaesse-gesund-halten",
  eyebrow: "Herz & Gefäße",
  title: "Herzgesunde Ernährung: Was ab 55 auf den Teller gehört",
  metaDescription:
  ...
  keyFacts: [
    ...
    "Wer mit frischen Kräutern, Knoblauch und Zitrone statt mit viel Salz würzt, isst geschmacklich abwechslungsreicher und zugleich maßvoller.",
    "Vitamin B1 trägt zu einer normalen Herzfunktion bei, Vitamin C trägt zur normalen Kollagenbildung für eine normale Funktion der Blutgefäße bei, und Selen und Zink tragen dazu bei, die Zellen vor oxidativem Stress zu schützen.",
    "Ein Nahrungsergänzungsmittel ersetzt weder eine ausgewogene Ernährung noch eine ärztliche Behandlung; wer Herz- oder Kreislaufmedikamente einnimmt, hält vor der Einnahme bitte Rücksprache mit Arzt oder Apotheker.",
  ],
  intro: [
  ...
  sections: [
    {
      heading: "Die Grundprinzipien einer mediterranen Kost",
      paragraphs: [
    ...
    {
      heading: "Welche Mikronährstoffe für Herz und Gefäße von Bedeutung sind",
      paragraphs: [
    ...
    {
      heading: "So setzen Sie es im Alltag um",
      paragraphs: [
  ...
  faq: [
    {
      q: "Was bedeutet herzgesunde Ernährung konkret?",
      a: "Gemeint ist meist ein mediterranes Muster mit viel Gemüse, Hülsenfrüchten, Obst und Vollkorn, regelmäßig Fisch, hochwertigen pflanzlichen Ölen wie Olivenöl sowie wenig Salz, Zucker und stark verarbeiteten Produkten. Es ist kein striktes Diätprogramm, sondern eine dauerhafte Ernährungsweise.",
    },
    {
      q: "Welche Mikronährstoffe sind für Herz und Gefäße relevant?",
      a: "Vitamin B1 trägt zu einer normalen Herzfunktion bei. Vitamin C trägt zur normalen Kollagenbildung für eine normale Funktion der Blutgefäße bei. Selen und Zink tragen dazu bei, die Zellen vor oxidativem Stress zu schützen. Diese Nährstoffe stecken in einer gemüse- und vollkornreichen Kost.",
    },
    {
      q: "Kann ein Nahrungsergänzungsmittel eine herzgesunde Ernährung ersetzen?",
      a: "Nein. Ein Nahrungsergänzungsmittel ist kein Arzneimittel und ersetzt weder eine ausgewogene Ernährung noch eine ärztliche Behandlung. Es kann eine bewusste Kost begleiten. Wenn Sie Herz- oder Kreislaufmedikamente einnehmen, halten Sie vor der Einnahme bitte Rücksprache mit Arzt oder Apotheker.",
    },
  ],
};
