...
export const ernaehrungGehirn: Article = {
  slug: "ernaehrung-fuers-gehirn",
  productSlug: "mentisana",
  pillarSlug: "gedaechtnis-staerken-im-alter",
  eyebrow: "Gedächtnis & Klarheit",
  title: "Ernährung fürs Gehirn ab 55: Was wirklich auf den Teller gehört",
  metaDescription:
  ...
  sections: [
    {
      heading: "Die Grundprinzipien einer hirnfreundlichen Ernährung",
      paragraphs: [
    ...
    {
      heading: "Mikronährstoffe für Kopf und Nerven",
      paragraphs: [
    ...
    {
      heading: "So setzen Sie das im Alltag um",
      paragraphs: [
  ...
  faq: [
    {
      q: "Welche Lebensmittel gehören in eine hirnfreundliche Ernährung?",
      a: "Viel Gemüse und etwas Obst, zweimal pro Woche fettreicher Seefisch oder pflanzliche Omega-3-Quellen wie Leinöl und Walnüsse, dazu Vollkornprodukte und Hülsenfrüchte. Zucker und stark verarbeitete Lebensmittel halten Sie am besten gering.",
    },
    {
      q: "Welche Mikronährstoffe spielen für Kopf und Nerven eine Rolle?",
      a: "Zink trägt zu einer normalen kognitiven Funktion bei. Vitamin B6 und Vitamin B12 tragen zu einer normalen Funktion des Nervensystems und zu einer normalen psychischen Funktion bei. Magnesium trägt zur normalen Funktion des Nervensystems bei. Diese Aussagen gelten für die Nährstoffe selbst.",
    },
    {
      q: "Kann ein Nahrungsergänzungsmittel eine gesunde Ernährung ersetzen?",
      a: "Nein. Ein Nahrungsergänzungsmittel ist kein Arzneimittel und ersetzt weder eine ausgewogene Ernährung noch eine ärztliche Behandlung. Es kann eine bewusste Lebensmittelauswahl begleiten, wenn die tägliche Versorgung mit einzelnen Nährstoffen schwerfällt.",
    },
  ],
};
