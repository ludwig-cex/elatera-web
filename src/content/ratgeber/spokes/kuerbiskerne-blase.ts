...
export const kuerbiskerneBlase: Article = {
  slug: "kuerbiskerne-blase",
  productSlug: "urisana",
  pillarSlug: "blase-harnwege-staerken",
  eyebrow: "Blase & Harnwege",
  title: "Kürbiskerne und die Blase: Tradition und Hintergrund",
  metaDescription:
  ...
  updated: "2026-06-15",
  heroImage: "/ratgeber-img/kuerbiskerne-blase.png",
  keyFacts: [
  ...
  sections: [
    {
      heading: "Die Tradition der Kürbiskerne",
      paragraphs: [
    ...
    {
      heading: "Was die Forschung neutral betrachtet hat",
      paragraphs: [
    ...
    {
      heading: "Einordnung und Anwendung im Alltag",
      paragraphs: [
  ...
  faq: [
    {
      q: "Helfen Kürbiskerne bei Blasenbeschwerden?",
      a: "Kürbiskerne sind ein Lebensmittel mit langer Tradition, kein Arzneimittel. Eine Wirkung gegen Beschwerden lässt sich daraus nicht ableiten. Bei anhaltenden oder belastenden Beschwerden im Bereich der Blase lassen Sie diese bitte ärztlich abklären.",
    },
    {
      q: "Was sagen die Studien zu pflanzlichen Inhaltsstoffen aus?",
      a: "Vorliegende Arbeiten, etwa von Wilt und Kollegen (2002) zu Sägepalme, Jepson und Kollegen (2012) zu Cranberry oder Kranjčec und Kollegen (2014) zu D-Mannose, betrachten einzelne, isolierte Stoffe. Sie erlauben keine Aussage über Kürbiskern und keinen Wirknachweis für ein konkretes Endprodukt.",
    },
    {
      q: "Kann ein kürbiskernhaltiges Nahrungsergänzungsmittel eine Behandlung ersetzen?",
      a: "Nein. Ein Nahrungsergänzungsmittel ist kein Arzneimittel und ersetzt weder eine ausgewogene Ernährung noch eine ärztliche Behandlung. Es kann einen gesunden Alltag begleiten. Bei Beschwerden sprechen Sie bitte mit Arzt oder Apotheker.",
    },
  ],
};
