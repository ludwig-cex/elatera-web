...
export const aufwaermenVorBewegung: Article = {
  slug: "aufwaermen-vor-bewegung",
  productSlug: "tendisana",
  pillarSlug: "sehnen-baender-gesund-halten",
  eyebrow: "Sehnen & Bänder",
  title: "Warum Aufwärmen vor Bewegung im Alter zählt",
  metaDescription:
  ...
  sections: [
    {
      heading: "Was beim Aufwärmen im Körper passiert",
      paragraphs: [
    ...
    {
      heading: "Eine einfache Aufwärm-Routine für den Alltag",
      paragraphs: [
    ...
    {
      heading: "Die Belastung danach langsam steigern",
      paragraphs: [
  ...
  faq: [
    {
      q: "Wie lange sollte ich mich vor Bewegung aufwärmen?",
      a: "Für die meisten Alltagsaktivitäten genügen fünf bis zehn Minuten mit lockerem Eingehen und ruhigem Durchbewegen der großen Gelenke. An kühlen Tagen oder am frühen Morgen darf es etwas länger sein, weil das Gewebe dann mehr Zeit braucht, um geschmeidig zu werden.",
    },
    {
      q: "Warum wird Aufwärmen mit dem Alter wichtiger?",
      a: "Mit den Jahren nimmt der Wassergehalt im Bindegewebe ab, und Sehnen und Bänder werden etwas weniger elastisch. Sie brauchen länger, bis sie nachgiebig sind. Ein ruhiger Einstieg bereitet diese Strukturen und die Gelenke auf die folgende Belastung vor.",
    },
    {
      q: "Welche Nährstoffe sind für Sehnen, Bänder und Bindegewebe relevant?",
      a: "Mangan trägt zu einer normalen Bindegewebsbildung bei, Vitamin C zur normalen Kollagenbildung für eine normale Funktion von Knorpel und Knochen. Vitamin D und Zink tragen zur Erhaltung normaler Knochen bei. Ein Nahrungsergänzungsmittel ist kein Arzneimittel und ersetzt weder Bewegung noch eine ärztliche Behandlung.",
    },
  ],
};
