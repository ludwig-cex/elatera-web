...
export const frueherAufwachen: Article = {
  slug: "frueher-aufwachen-im-alter",
  productSlug: "somnisana",
  pillarSlug: "besser-schlafen-im-alter",
  eyebrow: "Schlaf & Erholung",
  title: "Warum man im Alter früher aufwacht und was dahintersteckt",
  metaDescription:
  ...
  sections: [
    {
      heading: "Wie sich der Schlafrhythmus mit dem Alter verändert",
      paragraphs: [
    ...
    {
      heading: "Was im Alltag einen ruhigen Rhythmus unterstützt",
      paragraphs: [
    ...
    {
      heading: "Wann frühes Aufwachen ärztlich abzuklären ist",
      paragraphs: [
  ...
  faq: [
    {
      q: "Ist es normal, im Alter früher aufzuwachen?",
      a: "Ja. Mit den Jahren verschiebt sich die innere Uhr bei vielen Menschen nach vorne, man wird abends früher müde und morgens früher wach. Zugleich wird der Schlaf leichter. Das ist eine verbreitete und in der Regel harmlose Begleiterscheinung des Älterwerdens.",
    },
    {
      q: "Was hilft im Alltag, einen ruhigeren Rhythmus zu finden?",
      a: "Helles Tageslicht am Morgen und gedämpftes Licht am Abend stabilisieren die innere Uhr. Feste Zeiten für Aufstehen, Mahlzeiten und Zubettgehen, regelmäßige Bewegung tagsüber und Zurückhaltung bei Koffein am Abend unterstützen einen geregelten Schlaf-Wach-Rhythmus.",
    },
    {
      q: "Welche Nährstoffe spielen für das Nervensystem eine Rolle?",
      a: "Magnesium und Vitamin B6 tragen zur normalen Funktion des Nervensystems bei, Magnesium zudem zu einer normalen psychischen Funktion. Diese geprüften Aussagen gelten für die Nährstoffe selbst. Ein Nahrungsergänzungsmittel ersetzt keine ausgewogene Ernährung und keine ärztliche Behandlung.",
    },
  ],
};
