...
export const cranberryHarnwege: Article = {
  slug: "cranberry-harnwege",
  productSlug: "urisana",
  pillarSlug: "blase-harnwege-staerken",
  eyebrow: "Blase & Harnwege",
  title: "Cranberry und die Harnwege: Was bekannt ist",
  metaDescription:
  ...
  sections: [
    {
      heading: "Herkunft und Tradition der Cranberry",
      paragraphs: [
    ...
    {
      heading: "Wie Sie die Befunde einordnen",
      paragraphs: [
  ...
  faq: [
    {
      q: "Hilft Cranberry gegen eine Blasenentzündung?",
      a: "Eine solche Wirkung ist nicht belegt, und ein Nahrungsergänzungsmittel mit Cranberry ist kein Arzneimittel gegen Blasenentzündungen oder Harnwegsinfekte. Die Beere ist ein traditionsreiches Lebensmittel, dessen Inhaltsstoffe wissenschaftlich untersucht wurden. Bei Anzeichen eines Infekts lassen Sie die Beschwerden bitte ärztlich abklären.",
    },
    {
      q: "Was sagen die Studien zur Cranberry aus?",
      a: "Cranberry wurde unter anderem in einer Cochrane-Übersichtsarbeit von Jepson und Kollegen (2012) methodisch betrachtet. Solche Studien beziehen sich auf einzelne Inhaltsstoffe unter Studienbedingungen und erlauben keine Aussage über die Wirkung eines konkreten Endprodukts. Sie zeigen das Forschungsinteresse, nicht einen Wirknachweis.",
    },
    {
      q: "Kann ein Cranberry-Präparat eine ärztliche Behandlung ersetzen?",
      a: "Nein. Ein Nahrungsergänzungsmittel ist kein Arzneimittel und ersetzt weder eine ausgewogene Ernährung noch eine ärztliche Behandlung. Bei Brennen, häufigem Harndrang, Fieber oder anderen Infektzeichen suchen Sie bitte ärztlichen Rat, statt sich auf ein Präparat zu verlassen.",
    },
  ],
};
