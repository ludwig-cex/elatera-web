...
export const schlafhygiene60: Article = {
  slug: "schlafhygiene-ab-60",
  productSlug: "somnisana",
  pillarSlug: "besser-schlafen-im-alter",
  eyebrow: "Schlaf & Erholung",
  title: "Schlafhygiene ab 60: Die Abendroutine, die das Einschlafen erleichtert",
  metaDescription:
  ...
  sections: [
    {
      heading: "Die Schlafumgebung: dunkel, kühl und ruhig",
      paragraphs: [
    ...
    {
      heading: "Feste Zeiten, Licht und Bildschirme",
      paragraphs: [
    ...
    {
      heading: "Koffein, Alkohol und die Abendroutine",
      paragraphs: [
  ...
  faq: [
    {
      q: "Wie viel Schlaf brauche ich ab 60 überhaupt?",
      a: "Das Schlafbedürfnis ist individuell und liegt bei vielen Erwachsenen zwischen sieben und acht Stunden. Mit den Jahren wird der Schlaf oft leichter und kürzer. Entscheidend ist weniger die genaue Stundenzahl als das Gefühl, sich tagsüber ausreichend erholt zu fühlen.",
    },
    {
      q: "Ist ein Mittagsschlaf schlecht für die Nachtruhe?",
      a: "Nicht grundsätzlich. Ein kurzes Nickerchen am frühen Nachmittag kann guttun. Lange oder späte Schläfchen mindern jedoch den nächtlichen Schlafdruck und können das Einschlafen am Abend erschweren. Halten Sie den Mittagsschlaf daher eher kurz.",
    },
    {
      q: "Wann sollte ich Schlafprobleme ärztlich abklären lassen?",
      a: "Wenn Sie über mehrere Wochen schlecht ein- oder durchschlafen, sich tagsüber dauerhaft erschöpft fühlen oder lautes Schnarchen und Atemaussetzer auffallen, sprechen Sie mit Ihrem Arzt. Anhaltende Schlafprobleme gehören ärztlich abgeklärt. Ein Nahrungsergänzungsmittel ist kein Arzneimittel und ersetzt keine ärztliche Behandlung.",
    },
  ],
};
