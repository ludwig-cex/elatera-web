...
export const belastungSteuernBaender: Article = {
  slug: "belastung-steuern-baender",
  productSlug: "tendisana",
  pillarSlug: "sehnen-baender-gesund-halten",
  eyebrow: "Sehnen & Bänder",
  title: "Belastung richtig steuern bei empfindlichen Bändern",
  metaDescription:
  ...
  sections: [
    {
      heading: "Warum die Dosierung der Belastung so wichtig ist",
      paragraphs: [
    ...
    {
      heading: "Zeichen von Überlastung früh erkennen",
      paragraphs: [
    ...
    {
      heading: "Pausen und Regeneration richtig einplanen",
      paragraphs: [
  ...
  faq: [
    {
      q: "Sollte ich empfindliche Bänder lieber ganz schonen?",
      a: "Nein. Ruhendes Bindegewebe wird eher weniger belastbar. Sinnvoller ist, die Belastung maßvoll zu dosieren und in kleinen Schritten zu steigern, mit ruhigeren Tagen zwischen anstrengenderen. Bei anhaltenden oder starken Beschwerden lassen Sie das Gelenk bitte ärztlich abklären.",
    },
    {
      q: "Woran erkenne ich, dass ich ein Band überlastet habe?",
      a: "Frühe Zeichen sind ein ziehendes oder spannendes Gefühl, eine ungewohnte Steifigkeit am Folgetag oder ein druckempfindlicher Bereich, der an eine bestimmte Tätigkeit gekoppelt ist und mit Ruhe nachlässt. Schwellung, Überwärmung, plötzlicher heftiger Schmerz oder wochenlang anhaltende Beschwerden gehören ärztlich abgeklärt.",
    },
    {
      q: "Welche Nährstoffe sind für Sehnen und Bänder relevant?",
      a: "Mangan trägt zu einer normalen Bindegewebsbildung bei. Vitamin C trägt zur normalen Kollagenbildung für eine normale Funktion von Knorpel und Knochen bei. Vitamin D und Zink tragen zur Erhaltung normaler Knochen bei. Ein Nahrungsergänzungsmittel ist kein Arzneimittel und ersetzt weder eine ausgewogene Ernährung noch eine ärztliche Behandlung.",
    },
  ],
};
