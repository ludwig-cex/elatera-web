...
export const gehirnjoggingAb60: Article = {
  slug: "gehirnjogging-ab-60",
  productSlug: "mentisana",
  pillarSlug: "gedaechtnis-staerken-im-alter",
  eyebrow: "Gedächtnis & Klarheit",
  title: "Gehirnjogging ab 60: 6 Übungen für jeden Tag, ganz ohne Hilfsmittel",
  metaDescription:
  ...
  sections: [
    {
      heading: "Übung 1: Die Einkaufsliste im Kopf",
      paragraphs: [
    ...
    {
      heading: "Übung 2: Kopfrechnen an der Kasse",
      paragraphs: [
    ...
    {
      heading: "Übung 3: Der Andere-Hand-Moment",
      paragraphs: [
    ...
    {
      heading: "Übung 4: Neue Wege gehen, alte Wege nachzeichnen",
      paragraphs: [
    ...
    {
      heading: "Übung 5: Das Rückwärts-Tagebuch am Abend",
      paragraphs: [
    ...
    {
      heading: "Übung 6: Das Gesprächs-Gedächtnis",
      paragraphs: [
    ...
    {
      heading: "Was Ernährung und Mikronährstoffe beitragen können",
      paragraphs: [
  ...
  faq: [
    {
      ...
      a: "Lieber täglich ein paar Minuten als einmal pro Woche eine Stunde. Die sechs Übungen dieses Ratgebers sind bewusst so gewählt, dass sie in vorhandene Alltagsmomente passen. Zehn bis fünfzehn Minuten über den Tag verteilt sind ein sehr gutes Pensum.",
    },
    {
      q: "Ist Gehirnjogging ab 60 überhaupt noch wirksam?",
      a: "Das Gehirn bleibt ein Leben lang lernfähig und knüpft auch im höheren Alter neue Verbindungen, wenn es regelmäßig gefordert wird. Wichtig sind Abwechslung und Steigerung: Sobald eine Übung mühelos gelingt, braucht der Kopf den nächsten kleinen Anspruch.",
    },
    {
      q: "Was bringt mehr: Rätselhefte oder Alltagsübungen?",
      a: "Beides hat seinen Platz. Rätsel trainieren gezielt einzelne Fähigkeiten, werden aber mit der Zeit zur Routine. Alltagsübungen wie Kopfrechnen, Merklisten oder neue Wege haben den Vorteil, dass sie sich ständig verändern und keine zusätzliche Zeit kosten. Die beste Wirkung entsteht aus der Mischung.",
    },
    {
      q: "Welche Nährstoffe sind für die geistige Leistungsfähigkeit relevant?",
      a: "Zink trägt zu einer normalen kognitiven Funktion bei. Vitamin B6 und Vitamin B12 tragen zur normalen Funktion des Nervensystems und zur normalen psychischen Funktion bei. Diese geprüften Aussagen gelten für die Nährstoffe selbst, nicht für ein bestimmtes Produkt.",
    },
  ],
};
