...
export const gehirnjogging: Article = {
  slug: "gehirnjogging-uebungen",
  productSlug: "mentisana",
  pillarSlug: "gedaechtnis-staerken-im-alter",
  eyebrow: "Gedächtnis & Klarheit",
  title: "Gehirnjogging: Übungen, die Ihr Gedächtnis im Alltag fordern",
  metaDescription:
  ...
  sections: [
    {
      heading: "Neues lernen: der stärkste Reiz für den Kopf",
      paragraphs: [
    ...
    {
      heading: "Rätsel und Denkspiele gezielt einsetzen",
      paragraphs: [
    ...
    {
      heading: "Bewegung, Kontakte und gute Versorgung als Fundament",
      paragraphs: [
  ...
  faq: [
    {
      ...
      a: "Besser täglich ein wenig als einmal in der Woche viel. Schon zwanzig Minuten am Tag genügen, wenn sie regelmäßig stattfinden. Verteilen Sie kleine Übungen wie Kopfrechnen oder das Merken einer Liste über den Tag, dann bleibt das Training mühelos im Alltag.",
    },
    {
      q: "Welche Nährstoffe sind für die kognitive Funktion relevant?",
      a: "Zink trägt zu einer normalen kognitiven Funktion bei. Vitamin B6 und Vitamin B12 tragen zu einer normalen Funktion des Nervensystems und zu einer normalen psychischen Funktion bei. Diese von der EFSA geprüften Aussagen gelten für die Nährstoffe selbst und sind am besten über eine ausgewogene Ernährung gedeckt.",
    },
    {
      q: "Kann ein Nahrungsergänzungsmittel das Gehirntraining ersetzen?",
      a: "Nein. Ein Nahrungsergänzungsmittel ist kein Arzneimittel und ersetzt weder das geistige Training noch eine ausgewogene Ernährung oder eine ärztliche Behandlung. Es kann einen aktiven, anregungsreichen Alltag mit einer guten Nährstoffversorgung begleiten.",
    },
  ],
};
