...
export const ingwerGinkgo: Article = {
  slug: "ingwer-ginkgo-pflanzenkunde",
  productSlug: "vertisana",
  pillarSlug: "schwindel-gleichgewicht-im-alter",
  eyebrow: "Gleichgewicht & Balance",
  title: "Ingwer und Ginkgo: zwei traditionelle Pflanzen im Überblick",
  metaDescription:
  ...
  sections: [
    {
      heading: "Herkunft und Tradition von Ingwer und Ginkgo",
      paragraphs: [
    ...
    {
      heading: "Was die Forschung neutral untersucht hat",
      paragraphs: [
    ...
    {
      heading: "Anwendung und sachliche Einordnung",
      paragraphs: [
  ...
  faq: [
    {
      q: "Sind Ingwer und Ginkgo Arzneimittel?",
      a: "Nein. In Nahrungsergänzungsmitteln sind sie als Lebensmittelzutaten enthalten und keine Arzneimittel. Ein Nahrungsergänzungsmittel ersetzt weder eine ausgewogene Ernährung noch eine ärztliche Behandlung. Bei Beschwerden sprechen Sie bitte mit Arzt oder Apotheker.",
    },
    {
      q: "Belegen die genannten Studien eine Wirkung des Produkts?",
      a: "Nein. Die Arbeiten von Hilton und Kollegen (2017) zu Ginkgo und Marx und Kollegen (2015) zu Ingwer untersuchen einzelne Pflanzenextrakte unter Studienbedingungen. Sie lassen keinen Rückschluss auf die Wirkung eines konkreten Endprodukts zu.",
    },
    {
      q: "Gibt es bei Ginkgo etwas zu beachten?",
      a: "Inhaltsstoffe von Ginkgo können mit blutverdünnenden Mitteln in Wechselwirkung treten. Wenn Sie gerinnungshemmende Arzneimittel einnehmen oder vor einer Operation stehen, halten Sie vor der Anwendung bitte Rücksprache mit Ihrem Arzt oder Apotheker.",
    },
  ],
};
