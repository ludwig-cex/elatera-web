...
export const konzentration: Article = {
  slug: "konzentration-im-alltag",
  productSlug: "mentisana",
  pillarSlug: "gedaechtnis-staerken-im-alter",
  eyebrow: "Gedächtnis & Klarheit",
  title: "Konzentration im Alltag halten: praktische Wege zu mehr Klarheit",
  metaDescription:
  ...
  sections: [
    {
      heading: "Pausen und Single-Tasking: dem Kopf eine Sache zur Zeit geben",
      paragraphs: [
    ...
    {
      heading: "Schlaf, Bewegung und Trinken: die körperlichen Grundlagen",
      paragraphs: [
    ...
    {
      heading: "Ernährung und einzelne Mikronährstoffe als Begleiter",
      paragraphs: [
  ...
  faq: [
    {
      q: "Wie lange kann ich mich am Stück gut konzentrieren?",
      a: "Das ist von Mensch zu Mensch verschieden. Viele kommen gut mit Abschnitten von etwa fünfundvierzig Minuten zurecht, gefolgt von einer kurzen Pause. Probieren Sie aus, welcher Rhythmus zu Ihnen passt, und legen Sie anspruchsvolle Aufgaben möglichst in Ihre wachste Tageszeit.",
    },
    {
      q: "Welche Nährstoffe spielen für die geistige Klarheit eine Rolle?",
      a: "Zink trägt zu einer normalen kognitiven Funktion bei. Vitamin B6 und Vitamin B12 tragen zur normalen Funktion des Nervensystems und zu einer normalen psychischen Funktion bei, Magnesium ebenfalls zur normalen Funktion des Nervensystems. Diese Aussagen gelten für die Nährstoffe selbst.",
    },
    {
      q: "Kann ein Nahrungsergänzungsmittel meine Konzentration verbessern?",
      a: "Ein Nahrungsergänzungsmittel ist kein Arzneimittel und ersetzt weder eine ausgewogene Ernährung noch eine ärztliche Behandlung. Es kann einen aufmerksamen Alltag mit gutem Schlaf, Bewegung und ausreichendem Trinken begleiten, ist aber kein Ersatz für diese Grundlagen.",
    },
  ],
};
