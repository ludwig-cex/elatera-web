...
export const vitaminDGelenke: Article = {
  slug: "vitamin-d-gelenke-winter",
  productSlug: "mobilisana",
  pillarSlug: "gelenke-beweglichkeit-im-alter",
  eyebrow: "Gelenke & Beweglichkeit",
  title: "Vitamin D im Winter: Knochen und Muskeln in der dunklen Jahreszeit",
  metaDescription:
  ...
  sections: [
    {
      heading: "Warum Vitamin D im Winter oft knapp wird",
      paragraphs: [
    ...
    {
      heading: "Was Vitamin D für Knochen und Muskeln bedeutet",
      paragraphs: [
    ...
    {
      heading: "Alltags-Tipps für die dunkle Jahreszeit",
      paragraphs: [
  ...
  faq: [
    {
      q: "Warum ist die Vitamin-D-Versorgung im Winter oft geringer?",
      a: "Der Körper bildet den größten Teil seines Vitamin D über die Haut, wenn Sonnenlicht auf sie trifft. Zwischen Oktober und März steht die Sonne in unseren Breiten so tief, dass die UV-B-Strahlung dafür meist nicht ausreicht, und man hält sich seltener und bedeckter im Freien auf.",
    },
    {
      q: "Welche Rolle spielt Vitamin D für Knochen und Muskeln?",
      a: "Vitamin D trägt zur Erhaltung normaler Knochen und einer normalen Muskelfunktion bei. Diese Aussagen sind von der Europäischen Behörde für Lebensmittelsicherheit geprüft und gelten für den Nährstoff selbst. Magnesium und Zink unterstützen zusätzlich die Erhaltung normaler Knochen.",
    },
    {
      q: "Sollte ich im Winter einfach selbst hochdosiert Vitamin D nehmen?",
      a: "Davon ist abzuraten. Lassen Sie Ihren Vitamin-D-Status besser ärztlich überprüfen, statt auf eigene Faust hochdosiert zu ergänzen. Ein Nahrungsergänzungsmittel ist kein Arzneimittel und ersetzt weder eine ausgewogene Ernährung noch eine ärztliche Behandlung.",
    },
  ],
};
