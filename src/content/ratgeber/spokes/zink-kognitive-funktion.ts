...
export const zinkKognition: Article = {
  slug: "zink-kognitive-funktion",
  productSlug: "mentisana",
  pillarSlug: "gedaechtnis-staerken-im-alter",
  eyebrow: "Gedächtnis & Klarheit",
  title: "Zink und die normale kognitive Funktion: Welche Rolle das Spurenelement spielt",
  metaDescription:
  ...
  sections: [
    {
      heading: "Was Zink im Körper tut",
      paragraphs: [
    ...
    {
      heading: "Die geprüfte Aussage zur kognitiven Funktion",
      paragraphs: [
    ...
    {
      heading: "Gute Zinkquellen und wann eine Ergänzung sinnvoll sein kann",
      paragraphs: [
  ...
  faq: [
    {
      q: "Welche Aussage zur kognitiven Funktion ist für Zink geprüft?",
      a: "Zink trägt zu einer normalen kognitiven Funktion bei. Diese Aussage ist von der Europäischen Behörde für Lebensmittelsicherheit geprüft und gilt für den Nährstoff selbst. Sie bedeutet, dass Zink ein Baustein für den gewöhnlichen Ablauf geistiger Vorgänge ist, und besagt nicht, dass Zink das Gedächtnis verbessert oder Konzentration steigert.",
    },
    {
      q: "Über welche Lebensmittel nehme ich Zink auf?",
      a: "Reichhaltige Quellen sind Fleisch, Käse, Eier und Meeresfrüchte, aus denen der Körper Zink gut aufnimmt. Pflanzlich liefern Vollkornprodukte, Hülsenfrüchte, Nüsse und Kürbiskerne Zink. Wer sich abwechslungsreich ernährt, deckt seinen Bedarf in der Regel über die Nahrung.",
    },
    {
      q: "Wann ist eine Zink-Ergänzung sinnvoll und worauf sollte ich achten?",
      a: "Eine Ergänzung kann sinnvoll sein, wenn die Zufuhr über die Ernährung schwerfällt, etwa bei einseitiger Kost oder nachlassendem Appetit. Besprechen Sie das am besten mit Arzt oder Apotheker. Zink sollte nicht dauerhaft hochdosiert ohne fachlichen Rat eingenommen werden. Ein Nahrungsergänzungsmittel ist kein Arzneimittel.",
    },
  ],
};
