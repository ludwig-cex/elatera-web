...
export const bVitamineNervensystem: Article = {
  slug: "b-vitamine-nervensystem",
  productSlug: "vertisana",
  pillarSlug: "schwindel-gleichgewicht-im-alter",
  eyebrow: "Gleichgewicht & Balance",
  title: "B-Vitamine und das Nervensystem: Was B6 und B12 leisten",
  metaDescription:
  ...
  sections: [
    {
      heading: "Was Vitamin B6 und B12 sind",
      paragraphs: [
    ...
    {
      heading: "Der geprüfte EFSA-Claim zum Nervensystem",
      paragraphs: [
    ...
    {
      heading: "Gute Quellen und wann eine Ergänzung sinnvoll ist",
      paragraphs: [
  ...
  faq: [
    {
      q: "Was tragen Vitamin B6 und B12 zum Nervensystem bei?",
      a: "Vitamin B6 trägt zu einer normalen Funktion des Nervensystems bei und Vitamin B12 zur normalen Funktion des Nervensystems. Auch Magnesium trägt zur normalen Funktion des Nervensystems bei. Diese Aussagen sind geprüft und gelten für die Nährstoffe selbst, nicht für ein bestimmtes Produkt.",
    },
    {
      q: "Bekomme ich genug B-Vitamine über die Ernährung?",
      a: "Eine abwechslungsreiche, ausgewogene Kost deckt den Bedarf bei den meisten Menschen gut ab. Vitamin B6 steckt in Vollkorn, Hülsenfrüchten, Nüssen und Fisch, Vitamin B12 vor allem in tierischen Lebensmitteln. Bei rein pflanzlicher Ernährung oder im höheren Alter kann die Versorgung schwieriger sein.",
    },
    {
      q: "Sollte ich meinen B12-Status prüfen lassen?",
      a: "Wenn Sie eine dauerhafte Ergänzung erwägen, lassen Sie Ihren Vitamin-B12-Status ärztlich über eine Blutuntersuchung prüfen und besprechen das Vorgehen mit Arzt oder Apotheker. Ein Nahrungsergänzungsmittel ist kein Arzneimittel und ersetzt weder eine ausgewogene Ernährung noch eine ärztliche Behandlung.",
    },
  ],
};
