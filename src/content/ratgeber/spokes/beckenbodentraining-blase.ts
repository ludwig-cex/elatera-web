...
export const beckenbodentrainingBlase: Article = {
  slug: "beckenbodentraining-blase",
  productSlug: "urisana",
  pillarSlug: "blase-harnwege-staerken",
  eyebrow: "Blase & Harnwege",
  title: "Beckenbodentraining für eine starke Blase",
  metaDescription:
  ...
  sections: [
    {
      heading: "Was der Beckenboden ist und warum er die Blase stützt",
      paragraphs: [
    ...
    {
      heading: "Einfache Übungen für den Alltag",
      paragraphs: [
    ...
    {
      heading: "Dranbleiben, Geduld und die Rolle der Versorgung",
      paragraphs: [
  ...
  faq: [
    {
      q: "Wie finde ich die richtigen Beckenbodenmuskeln?",
      a: "Stellen Sie sich vor, Sie würden den Harnstrahl kurz anhalten oder einen Windhauch zurückhalten wollen. Die Anspannung nach innen und oben kommt aus dem Beckenboden, während Bauch, Gesäß und Oberschenkel locker bleiben. Sind Sie unsicher, hilft eine physiotherapeutische Anleitung.",
    },
    {
      q: "Wie lange dauert es, bis ein Training wirkt?",
      a: "Beckenbodenmuskulatur baut sich langsam auf. Entscheidend ist Beständigkeit: kurze Einheiten mehrmals täglich über mehrere Wochen. Geben Sie sich Zeit und beobachten Sie ruhig, wie sich das Gefühl für die Muskulatur entwickelt.",
    },
    {
      q: "Welche Nährstoffe sind für Blase und Harnwege relevant?",
      a: "Die Harnwege sind von Schleimhäuten ausgekleidet. Vitamin A trägt zur Erhaltung normaler Schleimhäute bei, Zink und Selen tragen dazu bei, die Zellen vor oxidativem Stress zu schützen. Ein Nahrungsergänzungsmittel ersetzt jedoch keine ärztliche Behandlung. Bei anhaltenden Beschwerden lassen Sie sich bitte ärztlich begleiten.",
    },
  ],
};
