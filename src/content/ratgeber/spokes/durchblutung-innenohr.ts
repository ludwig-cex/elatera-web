...
export const durchblutungInnenohr: Article = {
  slug: "durchblutung-innenohr",
  productSlug: "audisana",
  pillarSlug: "hoeren-ohren-im-alter",
  eyebrow: "Ohren & Hörfunktion",
  title: "Durchblutung und das Innenohr im Alter verstehen",
  metaDescription:
  ...
  sections: [
    {
      heading: "Wie das Innenohr mit Blut versorgt wird",
      paragraphs: [
    ...
    {
      heading: "Was die Forschung zu Ginkgo betrachtet hat",
      paragraphs: [
    ...
    {
      heading: "Eine Lebensweise, die die Durchblutung allgemein begünstigt",
      paragraphs: [
