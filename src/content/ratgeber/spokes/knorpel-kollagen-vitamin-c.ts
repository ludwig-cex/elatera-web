...
export const knorpelVitaminC: Article = {
  slug: "knorpel-kollagen-vitamin-c",
  productSlug: "mobilisana",
  pillarSlug: "gelenke-beweglichkeit-im-alter",
  eyebrow: "Gelenke & Beweglichkeit",
  title: "Knorpel, Kollagen und Vitamin C: Wie das Bindegewebe der Gelenke aufgebaut ist",
  metaDescription:
  ...
  sections: [
    {
      heading: "Was Knorpel ist und welche Rolle Kollagen dabei spielt",
      paragraphs: [
    ...
    {
      heading: "Weitere Mikronährstoffe für den Erhalt der Knochen",
      paragraphs: [
  ...
  faq: [
    {
      q: "Woraus besteht Gelenkknorpel?",
      a: "Gelenkknorpel ist eine elastische Schicht über den Knochenenden. Den festen Rahmen bildet das Strukturprotein Kollagen, in dessen Netzwerk Wasser und weitere Bausteine eingelagert sind. Versorgt wird der Knorpel über die Gelenkflüssigkeit, da er keine eigenen Blutgefäße hat.",
    },
    {
      q: "Welche Rolle spielt Vitamin C für die Knorpel?",
      a: "Vitamin C trägt zur normalen Kollagenbildung für die normale Funktion der Knorpel bei. Diese Aussage ist von der Europäischen Behörde für Lebensmittelsicherheit geprüft und gilt für den Nährstoff selbst. Sie bedeutet nicht, dass Vitamin C Knorpel aufbaut oder Beschwerden behandelt.",
    },
    {
      q: "Welche weiteren Nährstoffe sind für die Knochen relevant?",
      a: "Vitamin D, Magnesium und Zink tragen jeweils zur Erhaltung normaler Knochen bei. Magnesium trägt zudem zu einer normalen Muskelfunktion bei. Diese geprüften Aussagen beziehen sich auf die Nährstoffe selbst und ersetzen keine ausgewogene Ernährung und keine ärztliche Behandlung.",
    },
  ],
};
