...
export const weissdornPflanzenkunde: Article = {
  slug: "weissdorn-pflanzenkunde",
  productSlug: "cordisana",
  pillarSlug: "herz-gefaesse-gesund-halten",
  eyebrow: "Herz & Gefäße",
  title: "Weißdorn: Die traditionelle Pflanze im Überblick",
  metaDescription:
  ...
  sections: [
    {
      heading: "Herkunft und Tradition des Weißdorns",
      paragraphs: [
    ...
    {
      heading: "Was die Forschung zum Extrakt betrachtet hat",
      paragraphs: [
    ...
    {
      heading: "Einordnung: Pflanze, Nährstoffe und Verantwortung",
      paragraphs: [
  ...
  faq: [
    {
      q: "Woher stammt der Weißdorn und wie wurde er traditionell verwendet?",
      a: "Weißdorn ist ein heimisches Rosengewächs aus Hecken und Waldrändern Europas, Nordafrikas und Westasiens. Traditionell wurden Blätter mit Blüten sowie die Früchte gesammelt und zu Tees und Auszügen verarbeitet. Diese lange Tradition sagt für sich genommen nichts über eine konkrete Wirkung aus.",
    },
    {
      q: "Was hat die Forschung zum Weißdorn-Extrakt untersucht?",
      a: "Pittler und Kollegen (2008) haben Weißdorn-Extrakt in einer Cochrane-Übersichtsarbeit evaluiert. Solche Arbeiten beziehen sich auf den isolierten Inhaltsstoff und nicht auf ein bestimmtes Endprodukt. Aus ihnen lässt sich kein Wirknachweis für eine konkrete Rezeptur ableiten, und sie ersetzen keine ärztliche Einschätzung.",
    },
    {
      q: "Kann ein Weißdorn-Präparat das Herz stärken oder den Blutdruck beeinflussen?",
      a: "Nein. Ein Nahrungsergänzungsmittel ist kein Arzneimittel und trifft keine solchen Aussagen. Es ersetzt weder eine ausgewogene Ernährung noch eine ärztliche Behandlung. Bei Herzbeschwerden oder der Einnahme von Herz-Medikamenten halten Sie bitte unbedingt ärztliche Rücksprache.",
    },
  ],
};
