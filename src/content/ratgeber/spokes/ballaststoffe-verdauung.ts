...
export const ballaststoffeVerdauung: Article = {
  slug: "ballaststoffe-verdauung",
  productSlug: "gastrosana",
  pillarSlug: "verdauung-magen-unterstuetzen",
  eyebrow: "Magen & Verdauung",
  title: "Ballaststoffe und eine gute Verdauung im Alltag",
  metaDescription:
  ...
  updated: "2026-06-15",
  heroImage: "/ratgeber-img/ballaststoffe-verdauung.png",
  keyFacts: [
  ...
  sections: [
    {
      heading: "Was Ballaststoffe sind",
      paragraphs: [
    ...
    {
      heading: "Gute Quellen für den Alltag",
      paragraphs: [
    ...
    {
      heading: "Langsam steigern und ausreichend trinken",
      paragraphs: [
  ...
  faq: [
    {
      q: "Wie viele Ballaststoffe am Tag sind sinnvoll?",
      a: "Als allgemeine Orientierung werden für Erwachsene rund 30 Gramm am Tag genannt. Diese Menge erreichen Sie über eine abwechslungsreiche Kost aus Vollkornprodukten, Hülsenfrüchten, Gemüse, Obst sowie Nüssen und Samen. Steigern Sie die Menge am besten schrittweise.",
    },
    {
      q: "Warum ist Trinken bei einer ballaststoffreichen Kost so wichtig?",
      a: "Vor allem lösliche Ballaststoffe binden Wasser und brauchen ausreichend Flüssigkeit, um ihre Aufgabe im Darm gut zu erfüllen. Als Orientierung gelten rund eineinhalb bis zwei Liter am Tag, sofern ärztlich nichts anderes besprochen ist. Wasser und ungesüßte Tees eignen sich dafür gut.",
    },
    {
      q: "Kann ein Nahrungsergänzungsmittel eine ballaststoffreiche Ernährung ersetzen?",
      a: "Nein. Ein Nahrungsergänzungsmittel ist kein Arzneimittel und ersetzt weder eine ausgewogene Ernährung noch eine ärztliche Behandlung. Es kann eine pflanzenbetonte Kost und einen aktiven Alltag begleiten. Bei anhaltenden Beschwerden sprechen Sie bitte mit Arzt oder Apotheker.",
    },
  ],
};
